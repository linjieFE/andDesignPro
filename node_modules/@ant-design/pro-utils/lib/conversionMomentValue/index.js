...
exports.default = exports.dateFormatterMap = exports.convertMoment = exports.convertInitialValue = void 0;
...
var convertInitialValue = function convertInitialValue(value, dateFormatter, valueType) {
  ...
  if (dateFormatter) {
    if (Array.isArray(value)) {
      res = value.map(function (item) {
        if ((0, _moment.default)(item, true).isValid()) {
          return convertMoment((0, _moment.default)(item), dateFormatter, valueType);
        }

        return item;
      });
    } else {
      if ((0, _moment.default)(value, true).isValid()) {
        res = convertMoment((0, _moment.default)(value), dateFormatter, valueType);
      }
    }
  }
...
exports.convertInitialValue = convertInitialValue;
